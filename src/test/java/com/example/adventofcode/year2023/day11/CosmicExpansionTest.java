...
class CosmicExpansionTest {
    private static Stream<Arguments> filepathsAndExpectedSumOfDistances() {
        return Stream.of(
                Arguments.of("AdventOfCodeData/2023/day11/example_input", 374),
                Arguments.of("AdventOfCodeData/2023/day11/input", 9648398)
        );
    }
    ...
    private static Stream<Arguments> filepathsAndExpansionAndExpectedSumOfDistances() {
        return Stream.of(
                Arguments.of("AdventOfCodeData/2023/day11/example_input", 2, 374),
                Arguments.of("AdventOfCodeData/2023/day11/input", 2, 9648398),
                Arguments.of("AdventOfCodeData/2023/day11/example_input", 10, 1030),
                Arguments.of("AdventOfCodeData/2023/day11/example_input", 100, 8410),
                Arguments.of("AdventOfCodeData/2023/day11/example_input", 1000000, 82000210),
                Arguments.of("AdventOfCodeData/2023/day11/input", 1000000, 618800410814L)
        );
    }
