...
class PointOfIncidenceTest {
    private static Stream<Arguments> filepathsAndSmudgesAndExpectedSummarizedNotes() {
        return Stream.of(
                Arguments.of("AdventOfCodeData/2023/day13/example_input", 0, 405),
                Arguments.of("AdventOfCodeData/2023/day13/input", 0, 33122),
                Arguments.of("AdventOfCodeData/2023/day13/example_input", 1, 400),
                Arguments.of("AdventOfCodeData/2023/day13/input", 1, 32312)
        );
    }
