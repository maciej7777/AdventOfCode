...
class RockPaperScissorsTest {
    private static Stream<Arguments> filePathsAndExpectedStrategyScoreForMoves() {
        return Stream.of(
                Arguments.of("AdventOfCodeData/2022/day02/example_input", 15),
                Arguments.of("AdventOfCodeData/2022/day02/input", 11475)
        );
    }
    ...
    private static Stream<Arguments> filePathsAndExpectedStrategyScoreForResults() {
        return Stream.of(
                Arguments.of("AdventOfCodeData/2022/day02/example_input", 12),
                Arguments.of("AdventOfCodeData/2022/day02/input", 16862)
        );
    }
