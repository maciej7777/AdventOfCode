package com.example.adventofcode.day03;
...
class RucksackReorganizationTest {
    private static Stream<Arguments> filePathsAndExpectedSumOfPriorities() {
        return Stream.of(
                Arguments.of("src/main/java/com/example/adventofcode/day03/example_input", 157),
                Arguments.of("src/main/java/com/example/adventofcode/day03/input", 7428)
        );
    }
    ...
    private static Stream<Arguments> filePathsAndExpectedSumOfPrioritiesForBatches() {
        return Stream.of(
                Arguments.of("src/main/java/com/example/adventofcode/day03/example_input", 70),
                Arguments.of("src/main/java/com/example/adventofcode/day03/input", 2650)
        );
    }
