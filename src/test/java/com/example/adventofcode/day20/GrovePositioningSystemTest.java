package com.example.adventofcode.day20;
...
class GrovePositioningSystemTest {
    private static Stream<Arguments> filePathsAndExpectedSumOfGroveCoordinates() {
        return Stream.of(
                Arguments.of("src/main/java/com/example/adventofcode/day20/example_input",
                        3
                ),
                Arguments.of("src/main/java/com/example/adventofcode/day20/input",
                        7584
                )
        );
    }
