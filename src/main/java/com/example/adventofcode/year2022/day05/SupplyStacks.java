...
public class SupplyStacks {
    private static final String FILENAME = "AdventOfCodeData/2022day05/input";
    private static final String EXAMPLE_FILENAME = "AdventOfCodeData/2022day05/example_input";
