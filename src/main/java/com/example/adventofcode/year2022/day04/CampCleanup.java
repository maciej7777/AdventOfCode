...
public class CampCleanup {
    private static final String FILENAME = "AdventOfCodeData/2022day04/input";
    private static final String EXAMPLE_FILENAME = "AdventOfCodeData/2022day04/example_input";
