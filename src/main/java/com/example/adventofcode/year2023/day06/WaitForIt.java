...
public class WaitForIt {
    private static final String FILENAME = "AdventOfCodeData/2023/day06/input";
    private static final String EXAMPLE_FILENAME = "AdventOfCodeData/2023/day06/example_input";
