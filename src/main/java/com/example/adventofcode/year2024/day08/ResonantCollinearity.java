...
public class ResonantCollinearity {
    private static final String FILENAME = "AdventOfCodeData/2024/day08/input";
    private static final String EXAMPLE_FILENAME = "AdventOfCodeData/2024/day08/example_input";
